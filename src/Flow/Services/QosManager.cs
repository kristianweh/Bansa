...
///
/// Reversibility: every policy key is named with the prefix "Flow-Qos-".
...
{
    public const string PolicyPrefix = "Flow-Qos-";
    ...
    public static Task<bool> RemoveAllFlowPoliciesAsync()
        => Task.Run(() =>
        {
            try
            {
