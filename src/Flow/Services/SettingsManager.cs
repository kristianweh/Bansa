...
public class FlowSettings
{
    ...
    // so limits are only active while Flow is running.
...
public static class SettingsManager
{
    ...
    public static FlowSettings Load()
    {
        try
        {
            if (File.Exists(SettingsPath))
            {
                ...
                return JsonSerializer.Deserialize<FlowSettings>(json) ?? new FlowSettings();
            }
        }
    ...
    public static void Save(FlowSettings settings)
    {
        try
        {
